#!/bin/bash
# Pack every cooking take of EgoExo4D participant 55, plus each take's fisheye
...
#
# 4 takes, 18.7 minutes. Take indices: 1, 1, 1, 1.
# Capture(s): iiith_cooking_25, iiith_cooking_26, iiith_cooking_27, iiith_cooking_28.
#
...
tar -chvf "$OUT" \
    ...
    iiith_cooking_27_1/frame_aligned_videos/cam01.mp4 \
    iiith_cooking_27_1/frame_aligned_videos/cam02.mp4 \
    iiith_cooking_27_1/frame_aligned_videos/cam03.mp4 \
    iiith_cooking_27_1/frame_aligned_videos/cam04.mp4 \
    iiith_cooking_27_1/frame_aligned_videos/downscaled/448 \
    iiith_cooking_27_1/trajectory/gopro_calibs.csv \
