#!/bin/bash
# Pack every cooking take of EgoExo4D participant 58, plus each take's fisheye
...
#
# 6 takes, 19.5 minutes. Take indices: 1, 1, 1, 1, 1, 1.
# Capture(s): iiith_cooking_40, iiith_cooking_41, iiith_cooking_42, iiith_cooking_43, iiith_cooking_44, iiith_cooking_45.
#
